<x-app-layout>
    ...
    <div class="p-4 sm:p-8 bg-white dark:bg-foreground/20 shadow rounded-lg overflow-auto h-full w-full">
        ...
        <div class="pt-5 flex-grow">
            <div class="flex mb-4 border-b pb-5 gap-2">
                <div class="">
                ...
                <div class="ml-auto ">
                    <div class="ml-auto flex gap-2">
                        <button wire:click="resetFilters"
                            class="bg-primary text-white px-4 py-2 rounded">Search</button>
                        <button wire:click="resetFilters"
                            class="bg-destructive text-white px-4 py-2 rounded">Reset</button>
                        <button wire:click="resetFilters" class="bg-green-600 text-white px-4 py-2 rounded">Export To
                            Excel</button>
                    </div>
                </div>
            </div>
