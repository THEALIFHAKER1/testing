                    ...
                    <table class="w-full border rounded-md overflow-hidden p-1">
                        <thead>
                            <tr class="bg-primary">
                                ...
                                <th class="py-2 p-5 border">Approval Required</th>
                                <th class="py-2 p-5 border">Action</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr class="">
                                <td class="py-2 p-5 border">22/07/2024 02:00 PM</td>
                                <td class="py-2 p-5 border">jessicadora.anthony@petronas.com.my</td>
                                <td class="py-2 p-5 border">PO24072253A9</td>
                                <td class="py-2 p-5 border">3400406853</td>
                                <td class="py-2 p-5 border">RM 290899.50</td>
                                <td class="py-2 p-5 border">Pending</td>
                                <td class="py-2 p-5 border"><div class="bg-red-500 py-1 px-2 rounded-md text-white w-fit">
                                    No</div></td>
