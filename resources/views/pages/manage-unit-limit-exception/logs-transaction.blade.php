<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl">
            {{ __('Manage Users List Exception Logs') }}
        </h2>
    </x-slot>
    ...
    <div class="p-4 sm:p-8 bg-white dark:bg-foreground/20 shadow rounded-lg overflow-auto h-full w-full">
        <div class="w-full overflow-auto flex border-b pb-5">
            LIST OF LOGS (USERS TO EXCEPT UNIT LIMIT)
        </div>
                        ...
                        <table class="w-full border rounded-md overflow-hidden p-1">
                            <thead>
                                <tr class="bg-primary">
                                    ...
                                    <th class="py-2 p-5 border w-full">User Name(Staff who add)</th>
                                    <th class="py-2 p-5 border">User Name(Person Added)	</th>
                                    <th class="py-2 p-5 border">Operation</th>
                                    <th class="py-2 p-5 border">Timestamp</th>
                                    <th class="py-2 p-5 border">Action</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr class="bg-foreground/20">
                                    <td class="py-2 p-5 border text-center text-red-400" colspan="6">
                                        No User Found
                                    </td>
                                </tr>
                            </tbody>
